...
// RecommendationsGetNotFoundCode is the HTTP code returned for type RecommendationsGetNotFound
const RecommendationsGetNotFoundCode int = 404

/*RecommendationsGetNotFound NotFound

swagger:response recommendationsGetNotFound
*/
type RecommendationsGetNotFound struct {
...
// NewRecommendationsGetNotFound creates RecommendationsGetNotFound with default headers values
func NewRecommendationsGetNotFound() *RecommendationsGetNotFound {

	return &RecommendationsGetNotFound{}
}

// WithPayload adds the payload to the recommendations get not found response
func (o *RecommendationsGetNotFound) WithPayload(payload *types.Error) *RecommendationsGetNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the recommendations get not found response
func (o *RecommendationsGetNotFound) SetPayload(payload *types.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *RecommendationsGetNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
